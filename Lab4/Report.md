...
<img width="400" height="400" alt="Lab4 SQ5 Input1" src="https://github.com/user-attachments/assets/fb07f689-2921-4fe5-a801-39d1c409b3c9" /> <img width="400" height="400" alt="Lab4 SQ5 Output1" src="https://github.com/user-attachments/assets/88e802b4-c17f-4b6f-9280-93362a6caf70" />

Тест 2

<img width="400" height="400" alt="Lab4 SQ5 Input2" src="https://github.com/user-attachments/assets/4eb24fe1-15a1-4f10-a3d9-85afce3871a2" /> <img width="400" height="400" alt="Lab4 SQ5 Output2" src="https://github.com/user-attachments/assets/6fbf483c-cd97-4b3c-bf26-ef0c67869c26" />

Тест 3

<img width="400" height="400" alt="Lab4 SQ5 Input3" src="https://github.com/user-attachments/assets/13cecab1-f169-4422-9bc3-3a24fc67a786" /> <img width="400" height="400" alt="Lab4 SQ5 Output3" src="https://github.com/user-attachments/assets/86bbd2cf-21fd-4d80-9d4d-28643d42dbd2" />

Тест 4

<img width="400" height="400" alt="Lab4 SQ5 Input4" src="https://github.com/user-attachments/assets/89ceb8c1-781d-47b2-8b27-d88f53fefba3" /> <img width="400" height="400" alt="Lab4 SQ5 Output4" src="https://github.com/user-attachments/assets/9ab745f1-6bf5-48d1-bec6-aeb8631733c2" />

Тест 5

<img width="400" height="400" alt="Lab4 SQ5 Input5" src="https://github.com/user-attachments/assets/c0c1b3a9-8fc7-4117-b16c-674d46bbc4a4" /> <img width="400" height="400" alt="Lab4 SQ5 Output5" src="https://github.com/user-attachments/assets/62da1c1c-856e-4716-821c-c72c61778282" />
...
<img width="713" height="836" alt="Lab4 SQ12 Code" src="https://github.com/user-attachments/assets/fc9b21d5-e4f9-4ff3-8386-75ca489e483f" />


### Пояснение:

Для каждого элемента последовательности важно знать его правого и левого соседа, поэтому мы храним
ссылки на соседей каждого элемента. Если left[i] = 0 или right[i] = 0 - значит элемент стоит в начале
или в конце последовательности соответственно. Команда Left I J - запоминаем текущего левого соседа J, 
I связывается с с этим соседом и с J, после обнорвляем ссылки на соседей. Команда Right I J абсолютно 
аналогична, за исключением того, что используется уже правый сосед. Команда Leave I - получаем левого и
правого соседеей I, соединяем их между собой, минуая I, удаляем I. Команда name I - совсем просто, так как
мы и так храним левого и правого соседей для каждого элемента. 

### Тесты:

Как и в трёх предыдущих задания тесты я взял из описания лабы. (И их скрины тоже можно пропустить, они успешны)

Тест 1

<img width="400" height="400" alt="Lab4 SQ12 Input1" src="https://github.com/user-attachments/assets/dc99a4e9-5de6-45c7-bacc-984b36461025" /> <img width="400" height="400" alt="Lab4 SQ12 Output1" src="https://github.com/user-attachments/assets/2547a165-09ce-4219-8728-ab6c3ede44fa" />

Тест 2

<img width="400" height="400" alt="Lab4 SQ12 Input2" src="https://github.com/user-attachments/assets/06c56a1c-7be6-43ee-99ad-4c5cfb1f6249" /> <img width="400" height="400" alt="Lab4 SQ12 Output2" src="https://github.com/user-attachments/assets/28548eb4-5bbf-4933-bda2-e2697c4abc25" />
