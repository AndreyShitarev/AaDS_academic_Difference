...
Из этих результатов можно сделать вывод, что в моих тестах алгоритм
не работал за O(n) ни для одного из типов массивов. Но при этом лучше
всего справился с массивом с большим количесвтом однаковых элементов, а
хуже всего с массивом из случайных чисел.
