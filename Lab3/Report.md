...
держатся числа n - число строк, m - их длина и k - число фаз цифровой

сортировки (1 ≤ n ≤ 106, 1 ≤ k ≤ m ≤ 106 , n · m ≤ 5 · 107). Далее
находится описание строк, но в нетривиальном формате. Так, i-ая строка
(1 ≤ i ≤ n) записана в i-ых символах второй, ..., (m + 1)-ой строк вход-
ного файла. Иными словами, строки написаны по вертикали. Это сделано
специально, чтобы сортировка занимала меньше времени. Строки состоят из
 строчных латинских букв: от символа "a"до символа "z"включительно.
В таблице символов ASCII все эти буквы располагаются
подряд и в алфавитном порядке, код буквы "a"равен 97, код буквы "z"равен
122.

• Формат выходного файла (output.txt). Выведите номера строк в том по-
рядке, в котором они будут после k фаз цифровой сортировки.
...
<img width="706" height="698" alt="Lab3 QS7 Code" src="https://github.com/user-attachments/assets/c0351f96-023b-4dbe-9228-af0787c2c385" />

### Пояснение:

В этой задаче тоже главное - понять идею. Надо заметить, что на самом деле нам нужны не сами строки во входном файле, 
а строки составленные из одинаковых индексов исходных строк, то есть вертикальные строки. Мы будем сортировать по младшим разрядам.
И после k фаз мы будем получать нужный нам порядок.
Теперь про реализацию этой идеи. Строим строки, собирая их из вертикальных. То есть просто записываем вертикальные строки
как горизонтальные. С ними и будем работать. Вводим массив order, в котором будем хранить порядок индексов строк. Далее сама сортировка.
На каждой фазе она идёт по последней позиции: сначала m-1, затем m-2 и так до конца. Потом создаём 26 слотов для каждой буквы
английского алфавита. Раскалдываем индексы строк по этим слотам в зависимости от символа на текущей позиции. Далее
объединяем слоты в новый порядок. И в конце выводим номера строк в порядке после к фаз сортировки.

### Тесты:

Тут я, как и в задании 3, взял примеры из описания задания в лабе и получил следующее:

Тест 1:

<img width="547" height="360" alt="Lab3 QS7 Input1" src="https://github.com/user-attachments/assets/d9af145f-6469-4601-aacb-025917410fd3" />

<img width="552" height="364" alt="Lab3 QS7 Output1" src="https://github.com/user-attachments/assets/3f5229fc-6d5a-411c-aa9b-8737ad7500ab" />



Тест 2:

<img width="551" height="366" alt="Lab3 QS7 Input2" src="https://github.com/user-attachments/assets/265bbe16-b4a4-4cba-a3a1-96ffb4bf1eb9" />

<img width="550" height="360" alt="Lab3 QS7 Output2" src="https://github.com/user-attachments/assets/facd89ce-49c8-4695-952c-183c1b64fead" />



Тест 3:

<img width="555" height="361" alt="Lab3 QS7 Input3" src="https://github.com/user-attachments/assets/12be62c2-66c9-464f-91f5-26085546da04" />

<img width="544" height="356" alt="Lab3 QS7 Output3" src="https://github.com/user-attachments/assets/c8c0056b-9ace-464a-8ce0-46e950f75627" />
